...
//			String password = "pp123";
			...
			if (isPresent) {
				...
				String procedure = appModel.getXmlParser().getProcedureForGetPrivileges();
				CustomTreeModel restrictedTree = Login.treeModelWithAppliedPrivileges(appModel.getTreeModel(), userName, procedure);
				appModel.setTreeModel(restrictedTree);
